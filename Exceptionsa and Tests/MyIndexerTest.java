...
public class MyIndexerTest {
    ...
    //public  void accessToArrElements(int[] arr)
    // מצפה לקבל תוצאות על אינפוט ולידי legitimate input
    // index out of bound input - exception - יחולל אקספשיין
    ...
    // public  void getElement (int[] arr, int indexToPrint)
    // מצפה לקבל תוצאות על אינפוט ולידי legitimate input
    // index out of bound input - exception - יחולל אקספשיין
    ...
    // מצפה לקבל תוצאות על אינפוט ולידי legitimate input
    // index out of bound input negative - exception -  (אם קטן מגודל המערך גם יקבל יחולל אקספשיין
    // index too big custom exception - exception - יחולל אקספשיין
}
